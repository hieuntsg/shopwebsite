...
.service('halClient', [
    ...
    function (
        ...
        this.$del = function (href, options, data) {
        ...
        function Resource(href, options, data) {
            ...
            function embedResource(resource) {
                if (_.isArray(resource)) return resource.map(function (resource) {
            ...
            function callLink(method, link, params, data) {
                ...
                if (method === 'GET') {
                    if (_.has(embedded, linkHref)) { return embedded[linkHref]; }

                    return callService(method, linkHref, params, data);
                } else {
                    return callService(method, linkHref, params, data);
                }
        ...
        function createResource(href, options, data) {
            if (_.isArray(data)) return data.map(function (data) {
        ...
        function normalizeLink(baseHref, link) {
            if (_.isArray(link)) return link.map(function (link) {
